...
output "oracle_exascale_database_storage_vaults_description" {
  ...
  value       = { for k, v in azurerm_oracle_exascale_database_storage_vault.oracle_exascale_database_storage_vaults : k => v.description }
}
output "oracle_exascale_database_storage_vaults_display_name" {
  ...
  value       = { for k, v in azurerm_oracle_exascale_database_storage_vault.oracle_exascale_database_storage_vaults : k => v.display_name }
}
output "oracle_exascale_database_storage_vaults_high_capacity_database_storage" {
  ...
  value       = { for k, v in azurerm_oracle_exascale_database_storage_vault.oracle_exascale_database_storage_vaults : k => v.high_capacity_database_storage }
}
output "oracle_exascale_database_storage_vaults_location" {
  ...
  value       = { for k, v in azurerm_oracle_exascale_database_storage_vault.oracle_exascale_database_storage_vaults : k => v.location }
}
output "oracle_exascale_database_storage_vaults_name" {
  ...
  value       = { for k, v in azurerm_oracle_exascale_database_storage_vault.oracle_exascale_database_storage_vaults : k => v.name }
}
output "oracle_exascale_database_storage_vaults_resource_group_name" {
  ...
  value       = { for k, v in azurerm_oracle_exascale_database_storage_vault.oracle_exascale_database_storage_vaults : k => v.resource_group_name }
}
output "oracle_exascale_database_storage_vaults_tags" {
  ...
  value       = { for k, v in azurerm_oracle_exascale_database_storage_vault.oracle_exascale_database_storage_vaults : k => v.tags }
}
output "oracle_exascale_database_storage_vaults_time_zone" {
  ...
  value       = { for k, v in azurerm_oracle_exascale_database_storage_vault.oracle_exascale_database_storage_vaults : k => v.time_zone }
}
output "oracle_exascale_database_storage_vaults_zones" {
  ...
  value       = { for k, v in azurerm_oracle_exascale_database_storage_vault.oracle_exascale_database_storage_vaults : k => v.zones }
}
